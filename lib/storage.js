...
const types = require('scratch-asset-types');
...
function Storage () {
    ...
    this.client = new aws.S3({
        ...
        httpOptions: {
            ...
            timeout: process.env.DATA_TIMEOUT || 5000
        }
    });
}

Storage.prototype.renameObject = function (oldKey, newKey, callback) {
...
Storage.prototype.streamObjectIn = function (req, useTemp, callback) {
    ...
    this.client.upload({
        ...
        log.info('uploaded: ', status, ' size:', totalSize);
